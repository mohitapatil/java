...
public class ClaimPostgresImplTest {
    ...
    public void createClaimDaoInstance(){
        claim=new Claim(48568,34598462,
                60000,
    ...
    public void updateClaimTest(){
        ...
        try {
            assertTrue(claimFacade.updatePostgresClaim(48568,90000));
        } catch (SQLException e) {
            logger.info(e.getMessage());
        }
    }
...
//    }
    ...
    public void deleteClaimByIdTest(){
        ...
        try {
            assertTrue(claimFacade.deletePostgresClaimById(48568));
        } catch (SQLException e) {
            logger.info(e.getMessage());
        }
    }
    ...
    public void findClaimByIdTest(){
        ...
        try {
            assertNotNull(claimFacade.getPostgresClaimById(48568));
        } catch (SQLException e) {
           logger.info(e.getMessage());
        }
    }
